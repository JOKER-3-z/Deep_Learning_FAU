...
class FullyConnected(BaseLayer):
    ...
    def optimizer(self,op):
        self._optimizer=op
    def initialize(self,weights_initializer_method, bias_initializer_method):
        self.weights[:-1,:] = weights_initializer_method.initialize(self.weights_shape,self.weights_shape[0],self.weights_shape[1])
        self.weights[-1:,:] = bias_initializer_method.initialize(self.bias_shape,self.bias_shape[0],self.bias_shape[1])
